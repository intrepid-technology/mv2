...
import { addNewStepToServiceListingProcess, removeStepToServiceListingProcess, updateServiceList } from "../../../state/serviceListing/serviceListingSlice";
    ...
    <PlasmicServicelistingdescription
      ...
      processStepsArrayFields={{
        ...
        onChange: ({rowIndex, key, value }) => {
          ...
          dispatch(updateServiceList({key: `delivery.process.steps[${rowIndex}].${key}`, value}))
        },
        onAdd: () => {
