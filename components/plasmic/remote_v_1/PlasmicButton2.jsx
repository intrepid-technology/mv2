...
import sty from "./PlasmicButton2.module.css"; // plasmic-import: BM_HkBCd7wj/css
import ChecksvgIcon from "../market_v_2/icons/PlasmicIcon__Checksvg"; // plasmic-import: cvZrl8mqdA_/icon
import Icon52Icon from "./icons/PlasmicIcon__Icon52"; // plasmic-import: 9Lb3KzNlZGm/icon
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg___9La0S)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <Icon52Icon
                className={classNames(projectcss.all, sty.svg__d37Ay)}
                role={"img"}
              />
            ),
