...
import * as sty from "./PlasmicNotifications.module.css"; // plasmic-import: 1sHGjFsIBS/css

export const PlasmicNotifications__VariantProps = new Array();

export const PlasmicNotifications__ArgProps = new Array();
