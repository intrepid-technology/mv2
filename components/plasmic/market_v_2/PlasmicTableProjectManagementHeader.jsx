...
import * as sty from "./PlasmicTableProjectManagementHeader.module.css"; // plasmic-import: K0Z1ZWLiupV/css

export const PlasmicTableProjectManagementHeader__VariantProps = new Array();

export const PlasmicTableProjectManagementHeader__ArgProps = new Array();

function PlasmicTableProjectManagementHeader__RenderFunc(props) {
...
function makeNodeComponent(nodeName) {
  const func = function (props) {
    const { variants, args, overrides } = deriveRenderOpts(props, {
      ...
      internalArgPropNames: PlasmicTableProjectManagementHeader__ArgProps,
      internalVariantPropNames:
        PlasmicTableProjectManagementHeader__VariantProps
    });

    const { dataFetches } = props;
    return PlasmicTableProjectManagementHeader__RenderFunc({
      variants,
      args,
      overrides,
      dataFetches,
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicTableProjectManagementHeader";
  } else {
    func.displayName = `PlasmicTableProjectManagementHeader.${nodeName}`;
  }
  return func;
}

export const PlasmicTableProjectManagementHeader = Object.assign(
  // Top-level PlasmicTableProjectManagementHeader renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicTableProjectManagementHeader
    internalVariantProps: PlasmicTableProjectManagementHeader__VariantProps,
    internalArgProps: PlasmicTableProjectManagementHeader__ArgProps
  }
);

export default PlasmicTableProjectManagementHeader;
/* prettier-ignore-end */
