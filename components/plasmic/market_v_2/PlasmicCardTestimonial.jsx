...
import sty from "./PlasmicCardTestimonial.module.css"; // plasmic-import: 1Jyr2EbmPr/css
...
function PlasmicCardTestimonial__RenderFunc(props) {
  ...
  return (
    ...
    >
      ...
      <div className={classNames(projectcss.all, sty.freeBox___0GW0V)}>
        <div className={classNames(projectcss.all, sty.freeBox___7QjsC)}>
          <div className={classNames(projectcss.all, sty.freeBox__e3NvI)}>
            {p.renderPlasmicSlot({
              defaultContents:
        ...
        <div className={classNames(projectcss.all, sty.freeBox__n6Om6)}>
          <div className={classNames(projectcss.all, sty.freeBox__tIx4I)}>
            {p.renderPlasmicSlot({
        ...
        <div className={classNames(projectcss.all, sty.freeBox__ynnS1)}>
          <div className={classNames(projectcss.all, sty.freeBox__usx1B)}>
            {p.renderPlasmicSlot({
