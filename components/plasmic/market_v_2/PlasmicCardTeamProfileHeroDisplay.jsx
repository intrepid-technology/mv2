    ...
    >
      ...
      >
        <div
          ...
          className={classNames(defaultcss.all, projectcss.all, sty.headline)}
        >
          <div
            className={classNames(
              defaultcss.all,
      ...
      <p.Stack
        ...
        hasGap={true}
        className={classNames(defaultcss.all, projectcss.all, sty.buttonGroup, {
