...
import sty from "./PlasmicElementCheckoutSubHeadlineTotal.module.css"; // plasmic-import: ccLKsFE6cR/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox___8Spx)}
      >
        <div
      ...
      >
        <div
          ...
          className={classNames(projectcss.all, sty.ccurrencyParent)}
        >
          {p.renderPlasmicSlot({
            defaultContents: "$",
            value: args.currency,
        ...
        <div className={classNames(projectcss.all, sty.freeBox__h0Uqh)}>
          <div
            data-plasmic-name={"totalValueParent"}
            data-plasmic-override={overrides.totalValueParent}
            className={classNames(projectcss.all, sty.totalValueParent)}
          >
            {p.renderPlasmicSlot({
