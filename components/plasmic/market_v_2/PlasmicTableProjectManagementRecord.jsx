...
import * as sty from "./PlasmicTableProjectManagementRecord.module.css"; // plasmic-import: XwgjB__2WeM/css
...
export const PlasmicTableProjectManagementRecord__VariantProps = new Array(
  "status"
);

export const PlasmicTableProjectManagementRecord__ArgProps = new Array();

function PlasmicTableProjectManagementRecord__RenderFunc(props) {
  ...
  return (
    ...
    >
      ...
      {(hasVariant(globalVariants, "screen", "mobile") ? true : true) ? (
        ...
        >
          <IconTextPrimary
            data-plasmic-name={"iconTextPrimary"}
            data-plasmic-override={overrides.iconTextPrimary}
            className={classNames("__wab_instance", sty.iconTextPrimary)}
            elementIcon={
              <IconPrimary
...
const PlasmicDescendants = {
  ...
  svgIcon22: ["svgIcon22"],
  svgIcon3: ["svgIcon3"],
  progressParent: ["progressParent", "iconTextPrimary", "svgIcon23"],
  iconTextPrimary: ["iconTextPrimary", "svgIcon23"],
  svgIcon23: ["svgIcon23"],
...
function makeNodeComponent(nodeName) {
  const func = function (props) {
    const { variants, args, overrides } = deriveRenderOpts(props, {
      ...
      internalArgPropNames: PlasmicTableProjectManagementRecord__ArgProps,
      internalVariantPropNames:
        PlasmicTableProjectManagementRecord__VariantProps
    });

    const { dataFetches } = props;
    return PlasmicTableProjectManagementRecord__RenderFunc({
      variants,
      args,
      overrides,
      dataFetches,
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicTableProjectManagementRecord";
  } else {
    func.displayName = `PlasmicTableProjectManagementRecord.${nodeName}`;
  }
  return func;
}

export const PlasmicTableProjectManagementRecord = Object.assign(
  // Top-level PlasmicTableProjectManagementRecord renders the root element
  makeNodeComponent("root"),
  {
    ...
    iconTextPrimary: makeNodeComponent("iconTextPrimary"),
    ...
    // Metadata about props expected for PlasmicTableProjectManagementRecord
    internalVariantProps: PlasmicTableProjectManagementRecord__VariantProps,
    internalArgProps: PlasmicTableProjectManagementRecord__ArgProps
  }
);

export default PlasmicTableProjectManagementRecord;
/* prettier-ignore-end */
