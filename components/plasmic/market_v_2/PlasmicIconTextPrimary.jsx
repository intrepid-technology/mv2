...
import * as sty from "./PlasmicIconTextPrimary.module.css"; // plasmic-import: 2XsuG8W9wX/css
import Icon171Icon from "./icons/PlasmicIcon__Icon171"; // plasmic-import: RfkUw6C5x0/icon

export const PlasmicIconTextPrimary__VariantProps = new Array("size");

export const PlasmicIconTextPrimary__ArgProps = new Array(
  "elementIcon",
  "text",
  "text14Px",
  "text16Px",
...
function PlasmicIconTextPrimary__RenderFunc(props) {
            ...
            ? p.renderPlasmicSlot({
                defaultContents: (
                  <IconPrimary
                    ...
                    svgIcon={
                      <Icon171Icon
                        className={classNames(defaultcss.all, sty.svg__sibng)}
                        role={"img"}
                      />
                    }
                  />
            ...
            ? p.renderPlasmicSlot({
                defaultContents: (
                  <IconPrimary
                    ...
                    svgIcon={
                      <Icon171Icon
                        className={classNames(defaultcss.all, sty.svg__mEoft)}
                        role={"img"}
                      />
                    }
                  />
            ...
            ? p.renderPlasmicSlot({
                defaultContents: (
                  <IconPrimary
                    ...
                    svgIcon={
                      <Icon171Icon
                        className={classNames(defaultcss.all, sty.svg__vIb4J)}
                        role={"img"}
                      />
                    }
                  />
            ...
            ? p.renderPlasmicSlot({
                defaultContents: (
                  <IconPrimary
                    ...
                    svgIcon={
                      <Icon171Icon
                        className={classNames(defaultcss.all, sty.svg__idBwb)}
                        role={"img"}
                      />
                    }
                  />
            ...
            ? p.renderPlasmicSlot({
                defaultContents: (
                  <IconPrimary
                    ...
                    svgIcon={
                      <Icon171Icon
                        className={classNames(defaultcss.all, sty.svg__pC5Sw)}
                        role={"img"}
                      />
                    }
                  />
            ...
            ? p.renderPlasmicSlot({
                defaultContents: (
                  <IconPrimary
                    ...
                    svgIcon={
                      <Icon171Icon
                        className={classNames(defaultcss.all, sty.svg__s3Nop)}
                        role={"img"}
                      />
                    }
                  />
            ...
            ? p.renderPlasmicSlot({
                defaultContents: (
                  <IconPrimary
                    ...
                    svgIcon={
                      <Icon171Icon
                        className={classNames(defaultcss.all, sty.svg__ysQ8)}
                        role={"img"}
                      />
                    }
                  />
            ...
            ? p.renderPlasmicSlot({
                defaultContents: (
                  <IconPrimary
                    ...
                    svgIcon={
                      <Icon171Icon
                        className={classNames(defaultcss.all, sty.svg__zPz36)}
                        role={"img"}
                      />
                    }
                  />
            ...
            ? p.renderPlasmicSlot({
                defaultContents: (
                  <IconPrimary
                    ...
                    svgIcon={
                      <Icon171Icon
                        className={classNames(defaultcss.all, sty.svg__zCpm)}
                        role={"img"}
                      />
                    }
                  />
            ...
            ? p.renderPlasmicSlot({
                defaultContents: (
                  <IconPrimary
                    ...
                    svgIcon={
                      <Icon171Icon
                        className={classNames(defaultcss.all, sty.svg__xDzjQ)}
                        role={"img"}
                      />
                    }
                  />
...
function makeNodeComponent(nodeName) {
  const func = function (props) {
    const { variants, args, overrides } = deriveRenderOpts(props, {
      ...
      internalArgPropNames: PlasmicIconTextPrimary__ArgProps,
      internalVariantPropNames: PlasmicIconTextPrimary__VariantProps
    });

    const { dataFetches } = props;
    return PlasmicIconTextPrimary__RenderFunc({
      variants,
      args,
      overrides,
      dataFetches,
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicIconTextPrimary";
  } else {
    func.displayName = `PlasmicIconTextPrimary.${nodeName}`;
  }
  return func;
}

export const PlasmicIconTextPrimary = Object.assign(
  // Top-level PlasmicIconTextPrimary renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicIconTextPrimary
    internalVariantProps: PlasmicIconTextPrimary__VariantProps,
    internalArgProps: PlasmicIconTextPrimary__ArgProps
  }
);

export default PlasmicIconTextPrimary;
/* prettier-ignore-end */
