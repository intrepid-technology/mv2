...
import * as sty from "./PlasmicTableListingManagementHeader.module.css"; // plasmic-import: j0LNFrWCIRj/css

export const PlasmicTableListingManagementHeader__VariantProps = new Array();

export const PlasmicTableListingManagementHeader__ArgProps = new Array();

function PlasmicTableListingManagementHeader__RenderFunc(props) {
...
function makeNodeComponent(nodeName) {
  const func = function (props) {
    const { variants, args, overrides } = deriveRenderOpts(props, {
      ...
      internalArgPropNames: PlasmicTableListingManagementHeader__ArgProps,
      internalVariantPropNames:
        PlasmicTableListingManagementHeader__VariantProps
    });

    const { dataFetches } = props;
    return PlasmicTableListingManagementHeader__RenderFunc({
      variants,
      args,
      overrides,
      dataFetches,
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicTableListingManagementHeader";
  } else {
    func.displayName = `PlasmicTableListingManagementHeader.${nodeName}`;
  }
  return func;
}

export const PlasmicTableListingManagementHeader = Object.assign(
  // Top-level PlasmicTableListingManagementHeader renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicTableListingManagementHeader
    internalVariantProps: PlasmicTableListingManagementHeader__VariantProps,
    internalArgProps: PlasmicTableListingManagementHeader__ArgProps
  }
);

export default PlasmicTableListingManagementHeader;
/* prettier-ignore-end */
