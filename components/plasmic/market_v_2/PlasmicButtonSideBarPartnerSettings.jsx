...
import * as sty from "./PlasmicButtonSideBarPartnerSettings.module.css"; // plasmic-import: AS7ILA_RiJ/css
import ChevronDownBIcon from "./icons/PlasmicIcon__ChevronDownB"; // plasmic-import: wk3elY0ALL/icon

export const PlasmicButtonSideBarPartnerSettings__VariantProps = new Array();

export const PlasmicButtonSideBarPartnerSettings__ArgProps = new Array(
  "target",
  "trigger"
);

function PlasmicButtonSideBarPartnerSettings__RenderFunc(props) {
...
function makeNodeComponent(nodeName) {
  const func = function (props) {
    const { variants, args, overrides } = deriveRenderOpts(props, {
      ...
      internalArgPropNames: PlasmicButtonSideBarPartnerSettings__ArgProps,
      internalVariantPropNames:
        PlasmicButtonSideBarPartnerSettings__VariantProps
    });

    const { dataFetches } = props;
    return PlasmicButtonSideBarPartnerSettings__RenderFunc({
      variants,
      args,
      overrides,
      dataFetches,
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicButtonSideBarPartnerSettings";
  } else {
    func.displayName = `PlasmicButtonSideBarPartnerSettings.${nodeName}`;
  }
  return func;
}

export const PlasmicButtonSideBarPartnerSettings = Object.assign(
  // Top-level PlasmicButtonSideBarPartnerSettings renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicButtonSideBarPartnerSettings
    internalVariantProps: PlasmicButtonSideBarPartnerSettings__VariantProps,
    internalArgProps: PlasmicButtonSideBarPartnerSettings__ArgProps
  }
);

export default PlasmicButtonSideBarPartnerSettings;
/* prettier-ignore-end */
