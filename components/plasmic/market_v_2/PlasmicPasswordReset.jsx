...
import SectionPasswordReset from "../../SectionPasswordReset"; // plasmic-import: Olpj-oqQtA/component
import FooterB from "../../FooterB"; // plasmic-import: kxeO2gTzwxU/component
import "@plasmicapp/react-web/lib/plasmic.css";
import * as defaultcss from "../plasmic__default_style.module.css"; // plasmic-import: global/defaultcss
import * as projectcss from "./plasmic_market_v_2.module.css"; // plasmic-import: 3jRhtnjrFaHJWfNWC1k5BV/projectcss
import * as sty from "./PlasmicPasswordReset.module.css"; // plasmic-import: SEKSUTmj_v/css
...
function PlasmicPasswordReset__RenderFunc(props) {
  ...
  return (
    <React.Fragment>
      <Head>
        <title key="title">{"Password reset | Intrepid Market"}</title>
        <meta
          key="og:title"
          property="og:title"
          content={"Password reset | Intrepid Market"}
        />
      ...
      <div className={defaultcss.plasmic_page_wrapper}>
        ...
        >
          ...
          <SectionPasswordReset
            data-plasmic-name={"sectionPasswordReset"}
            data-plasmic-override={overrides.sectionPasswordReset}
            className={classNames("__wab_instance", sty.sectionPasswordReset)}
          />
...
const PlasmicDescendants = {
  root: ["root", "navbarStatic", "sectionPasswordReset", "footerB"],
  navbarStatic: ["navbarStatic"],
  sectionPasswordReset: ["sectionPasswordReset"],
  footerB: ["footerB"]
};
...
export const PlasmicPasswordReset = Object.assign(
  ...
  makeNodeComponent("root"),
  {
    ...
    sectionPasswordReset: makeNodeComponent("sectionPasswordReset"),
