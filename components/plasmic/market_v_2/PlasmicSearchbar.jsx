...
import * as sty from "./PlasmicSearchbar.module.css"; // plasmic-import: MorSLptejY/css
import Icon174Icon from "./icons/PlasmicIcon__Icon174"; // plasmic-import: yq36rktOQq/icon

export const PlasmicSearchbar__VariantProps = new Array(
  "type",
  "width",
  "height"
);

export const PlasmicSearchbar__ArgProps = new Array();
