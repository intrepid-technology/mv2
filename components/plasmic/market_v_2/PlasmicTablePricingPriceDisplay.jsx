...
import sty from "./PlasmicTablePricingPriceDisplay.module.css"; // plasmic-import: _lVEBPxny8/css

export const PlasmicTablePricingPriceDisplay__VariantProps = new Array();

export const PlasmicTablePricingPriceDisplay__ArgProps = new Array(
  "children",
  "slot",
  "slot2",
  "slot3",
